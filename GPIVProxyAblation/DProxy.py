...
class ProxyGaussianProcess:
    ...
    def _compute_kernel_matrices(self):
        ...
        self.C = (self.Ktz @ self.invKtz @ (self.Ktt * self.Kuu) @ self.invKtz @ self.Ktz +
                  self.lambda_val * torch.eye(len(self.z), dtype=torch.float64))
...
if __name__ == "__main__":
    ...
    n_folds = 5
    lambda_candidates = [0.01, 0.05, 0.1, 0.2, 0.3, 0.5, 0.7, 1.0]
    manual_lambda = 0.5
    t_test_start = 10
    t_test_end = 40
    n_test_points = 300
